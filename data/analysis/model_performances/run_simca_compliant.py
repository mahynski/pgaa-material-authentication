# SIMCA Model using TEFF as the metric
            ...
            for dim_red in [None]: # SIMCA uses PCA internally so no sense in doing it twice
                ...
                for scaling in scalings:
                    ...
                    try:
                        ...
                        steps += [('model', SIMCA_Classifier(target_class=target_class, style="dd-simca", use="compliant", robust=None, sft=False))]
                        param_grid.update({
